				...
				<div class="bdt-prime-slider-content">
					...
					<?php if ($slide_content['sub_title'] && ('yes' == $settings['show_sub_title'])) : ?>
						<div class="bdt-sub-title">
							<<?php echo Utils::get_valid_html_tag($settings['sub_title_html_tag']); ?> class="bdt-sub-title-inner" data-bdt-slideshow-parallax="x: 100,-100; opacity: 1,1,0">
					...
					<?php if ($slide_content['title'] && ('yes' == $settings['show_title'])) : ?>
						<div class="bdt-main-title">
							<<?php echo Utils::get_valid_html_tag($settings['title_html_tag']); ?> class="bdt-title-tag"  data-bdt-slideshow-parallax="x: 200,-200; opacity: 1,1,0">
					...
					<?php if ($slide_content['excerpt'] && ('yes' == $settings['show_excerpt'])) : ?>
						<div class="bdt-slider-excerpt" data-bdt-slideshow-parallax="x: 300,-300; opacity: 1,1,0">
