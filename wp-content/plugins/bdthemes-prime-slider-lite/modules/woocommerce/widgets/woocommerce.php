		...
		?>
			<div class="bdt-ps-slideshow-content-wrapper">
				...
				<?php if ($settings['show_category']) : ?>
					<div class="bdt-ps-category" data-bdt-slideshow-parallax="y: 50,0,-110; opacity: 1,1,0">
						<?php echo wc_get_product_category_list(get_the_ID(), ' '); ?>
					</div>
				<?php endif; ?>

				<?php if ($settings['show_title']) : ?>
					<<?php echo Utils::get_valid_html_tag($settings['title_html_tag']); ?> class="bdt-ps-title" data-bdt-slideshow-parallax="y: 70,0,-100; opacity: 1,1,0">
				...
				<?php if ($settings['show_excerpt']) : ?>
					<div class="bdt-ps-text" data-bdt-slideshow-parallax="y: 90,0,-90; opacity: 1,1,0"><?php the_excerpt(); ?></div>
				<?php endif; ?>
